                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="InstructorID" name="InstructorID" required>
                                ...
                                @foreach ($instructors as $instructor)
                                    <option value="{{ $instructor->id}}" {{ (isset($qualification) && $qualification->InstructorID == $instructor->id) ? 'selected' : '' }}>{{ $instructor->InstructorName }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="TopicID" name="TopicID" required>
                                ...
                                @foreach ($courses as $course)
                                    <option value="{{ $course->id}}" {{ (isset($qualification) && $qualification->TopicID == $course->id) ? 'selected' : '' }}>{{ $course->CourseName }}</option>
                                @endforeach
                            </select>
                        </div>
